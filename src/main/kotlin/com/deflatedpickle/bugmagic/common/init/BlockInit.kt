...
import com.deflatedpickle.bugmagic.common.block.ImmobileServantTotemBlock
import com.deflatedpickle.bugmagic.common.block.HeadOfPig
...
object BlockInit {
	...
	@JvmField
	val IMMOBILE_SERVANT = ImmobileServantTotemBlock()

	// Heads
	// haha head

	@JvmField
	val PIG_HEAD = HeadOfPig()

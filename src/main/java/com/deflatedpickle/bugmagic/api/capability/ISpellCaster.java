 ...
 * <p>
 * Officially, this is for items, such as a wand, but this count be added to anything
 *
 * @author DeflatedPickle
 * @see ISpellLearner
 * @see com.deflatedpickle.bugmagic.common.capability.SpellCaster
 */
public interface ISpellCaster {
     ...
     * <p>
     * Officially, this is for a player that owns a wand, but if applied to a player, this would be the player.
     * The player would need to be a {@link ISpellLearner} for this to be of much use.
     *

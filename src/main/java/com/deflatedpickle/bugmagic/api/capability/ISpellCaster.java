 ...
 * @see ISpellLearner
 * @see com.deflatedpickle.bugmagic.common.capability.SpellCasterCapability
 */
public interface ISpellCaster {
   ...
   * the player. The player would need to be a {@link ISpellLearner} for this to be of much use.
   *
